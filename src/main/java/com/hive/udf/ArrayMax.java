...
public class ArrayMax extends GenericUDF {
    ...
    public Object evaluate(DeferredObject[] arguments) throws HiveException {
        ...
        Object maxElement = arrayOI.getListElement(array, 0);
        for (int i = 0; i < arrayLength; i++) {
            if (ObjectInspectorUtils.compare(maxElement, this.arrayElementOI, arrayOI.getListElement(array, i), this.arrayElementOI) < 0)
                maxElement = arrayOI.getListElement(array, i);
        }
